/*! MIT license, more info: wgo.waltheri.net */(function(b,p){var g=function(u){var a=new r(JSON.parse(JSON.stringify(u.getProperties()))),c;for(c in u.children)a.appendChild(g(u.children[c]));return a},f=function(u,a){var c;if(a[u]!==p)return a[u];for(var h in a.children)if(c=f(u,a.children[h]))return c;return!1},l=function(a,c){a.push(JSON.parse(JSON.stringify(c.getProperties())));if(1<c.children.length){for(var h=[],e=0;e<c.children.length;e++){var d=[];l(d,c.children[e]);h.push(d)}a.push(h)}else c.children.length&&l(a,c.children[0])},d=function(a,
c){for(var h=c,e,b=1;b<a.length;b++)if(a[b].constructor==Array)for(var k=0;k<a[b].length;k++)e=new r(a[b][k][0]),h.appendChild(e),d(a[b][k],e);else e=new r(a[b]),h.insertAfter(e),h=e},k=function(a){return"string"==typeof a?a.replace(/\\/g,"\\\\").replace(/]/g,"\\]"):a},a=function(a,c){return String.fromCharCode(97+a)+String.fromCharCode(97+c)},h=function(a,c,h){if(c.length){h.sgf+=a;for(var e in c)h.sgf+="["+c[e]+"]"}},n=function(c,e){if(c.move){var d="";c.pass||(d=a(c.move.x,c.move.y));e.sgf=c.move.c==
b.B?e.sgf+("B["+d+"]"):e.sgf+("W["+d+"]")}if(c.setup){var d=[],m=[],f=[],q;for(q in c.setup)c.setup[q].c==b.B?d.push(a(c.setup[q].x,c.setup[q].y)):c.setup[q].c==b.W?m.push(a(c.setup[q].x,c.setup[q].y)):f.push(a(c.setup[q].x,c.setup[q].y));h("AB",d,e);h("AW",m,e);h("AE",f,e)}if(c.markup){d={};for(q in c.markup)d[c.markup[q].type]=d[c.markup[q].type]||[],"LB"==c.markup[q].type?d.LB.push(a(c.markup[q].x,c.markup[q].y)+":"+k(c.markup[q].text)):d[c.markup[q].type].push(a(c.markup[q].x,c.markup[q].y));
...
goTo:function(a){if(!this.frozen&&this.kifu){var e;"function"==typeof a&&(a=a.call(this));"number"==typeof a?(e=b.clone(this.kifuReader.path),e.m=a||0):e=a;try{this.kifuReader.goTo(e),this.update()}catch(d){this.error(d)}}},getGameInfo:function(){if(!this.kifu)return null;var a={},e;for(e in this.kifu.info)-1!=b.Kifu.infoList.indexOf(e)&&(b.Kifu.infoFormatters[e]?a[b.t(e)]=b.Kifu.infoFormatters[e](this.kifu.info[e]):a[b.t(e)]=b.filterHTML(this.kifu.info[e]));return a},setFrozen:function(a){this.frozen=
a;this.dispatchEvent({type:this.frozen?"frozen":"unfrozen",target:this})},appendTo:function(a){a.appendChild(this.element)},focus:function(){this.config.enableKeys&&this.setKeys(!0)},setKeys:function(c){document.onkeydown=c?a.bind(this):null},setWheel:function(a){!this._wheel_listener&&a?(this._wheel_listener=k.bind(this),a=void 0!==document.onmousewheel?"mousewheel":"DOMMouseScroll",this.element.addEventListener(a,this._wheel_listener)):this._wheel_listener&&!a&&(a=void 0!==document.onmousewheel?
"mousewheel":"DOMMouseScroll",this.element.removeEventListener(a,this._wheel_listener),delete this._wheel_listener)},setCoordinates:function(a){!this.coordinates&&a?(this.board.theme.coordinatesBackgroundColor?this.board.setSection(-1,-1,-1,-1):this.board.setSection(-.5,-.5,-.5,-.5),this.board.addCustomObject(b.Board.coordinates)):this.coordinates&&!a&&(this.board.setSection(0,0,0,0),this.board.removeCustomObject(b.Board.coordinates));this.coordinates=a}};n.default={sgf:void 0,json:void 0,sgfFile:void 0,
move:void 0,board:{},enableWheel:!0,lockScroll:!0,enableKeys:!0,rememberPath:!0,kifuLoaded:void 0,update:void 0,frozen:void 0,unfrozen:void 0,allowIllegalMoves:!1,markLastMove:!0};b.Player=n;var m={"about-text":"<h1>WGo.js Player 2.0</h1><p>WGo.js Player is extension of WGo.js, HTML5 library for purposes of game of go. It allows to replay go game records and it has many features like score counting. It is also designed to be easily extendable.</p><p>WGo.js is open source licensed under <a href='http://en.wikipedia.org/wiki/MIT_License' target='_blank'>MIT license</a>. You can use and modify any code from this project.</p><p>You can find more information at <a href='http://wgo.waltheri.net/player' target='_blank'>wgo.waltheri.net/player</a></p><p>Copyright &copy; 2013 Jan Prokop</p>",
...
"Game info";b.BasicPlayer.component.CommentBox=k})(WGo);(function(b,p){var g=b.extendClass(b.BasicPlayer.component.Component,function(a){this.super(a);this.widgets=[];this.element.className="wgo-player-control";this.iconBar=document.createElement("div");this.iconBar.className="wgo-control-wrapper";this.element.appendChild(this.iconBar);var b,d;for(d in g.widgets)b=new g.widgets[d].constructor(a,g.widgets[d].args),b.appendTo(this.iconBar),this.widgets.push(b)});g.prototype.updateDimensions=function(){this.element.className=340>this.element.clientWidth?
